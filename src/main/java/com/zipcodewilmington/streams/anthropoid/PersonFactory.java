...
public final class PersonFactory {
    ...
    public List<Person> createPersonList(int listSize) {
        Stream<Person> streamPerson= Stream.generate(this::createRandomPerson).limit(listSize);
        List<Person> pList=streamPerson.collect(Collectors.toList());
        return pList;
    }
    ...
    public Person[] createPersonArray(int arrayLength) {
        Stream<Person> streamPerson= Stream.generate(this::createRandomPerson).limit(arrayLength);
        Person [] pArray=streamPerson.toArray(Person[]::new);
        return pArray;
    }
    ...
    public Stream<Person> createPersonStream(int streamCount) {
        Stream<Person> streamPerson= Stream.generate(this::createRandomPerson).limit(streamCount);
        return streamPerson;
    }
}
